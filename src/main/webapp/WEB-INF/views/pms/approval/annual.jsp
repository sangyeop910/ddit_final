									...
									<tr>
										...
										<td
											...
											<span unselectable="on" contenteditable="false" class="comp_wrap"
												...
												<span class="comp_item">${empvo.department.depNm }</span>
												<input type="hidden"  id="annDep" name="annDep" value="${empvo.department.depNm}"  />
											</span>
										</td>
									</tr>
									<tr>
				    			 ...
				    			 <span class="sign_member_wrap" id="activity_">
				    			 	<span class="sign_member">
				    			 		<span class="sign_rank_wrap">
				    						 ...
				    						 <input type="hidden" id="aprlineDep" name="aprlineDep" value="${empvo.position.posiNm}" />
				    					 </span>
					    				 <span class="sign_wrap">
					    					 <span class="sign_name">${empvo.empName }</span>
				    						 <input type="hidden" id="empId" name="lineList[0].empName" value="${empvo.empName}" />
					    			 	</span>
			...
			<table class="caltable" style="width: 800px; margin-top: 10px; border-collapse: collapse !important; color: black; background: white; border: 1px solid black; font-size: 12px; font-family: malgun gothic, dotum, arial, tahoma;">
				<tbody>
					<tr>
	                    ...
	                    <input type="hidden" id="aprKind" name="aprKind" value="${pmsapproval.aprKind }" />
						</td>
					</tr>
					<tr>
						<td
							...
							<span id="vacationHalfArea"
								...
								<span class="halfArea">
									...
									<label class="editor_label" data-type="removeSpan">오후</label>
							          <input type="hidden" id="halfDay" name="halfDay" value="${pmsapproval.halfDay }" />
								</span>
...
function insertHalfDay(){
    var radio = document.querySelector('input[name="radio_startHalf"]:checked');
    var hidden = document.getElementById('halfDay');
    if (radio && hidden) {
...
function insertContent(){
    ...
    var pmshidden = document.getElementById('aprContent');
    hidden.value = textarea.value;
    pmshidden.value = textarea.value;
}
...
function insertSelect(){
	...
	var pmshidden = document.getElementById('aprKind');
	hidden.value = select.value;
	pmshidden.value = select.value;
}
